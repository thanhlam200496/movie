                    ...
                    <div class="row row-eq-height header-top">
                        <div class="user-profile">
                            ...
                            <div class="user-info">
                                <h5>Emily Jane</h5>
                                <p class="address"></p>
                                <p class="level-nemberships">Free Plan</p>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-8 col-lg-8 col-12 h-left">
                            ...
                            <ul class="nav">
                                ...
                                <li class="nav-item nav-history"><a class="item-history "
                                        href="https://streamvid.jwsuperthemes.com/author/emily/history"> <span
                                ...
                                <li class="nav-item nav-playlist"><a class="item-playlist "
                                        href="https://streamvid.jwsuperthemes.com/author/emily/playlist"> <span
                                            class="menu-text">Playlist</span></a></li>
                                <li class="nav-item nav-watchlist"><a class="item-watchlist "
                                        href="https://streamvid.jwsuperthemes.com/author/emily/watchlist"> <span
                                            class="menu-text">Watchlist</span></a></li>
                                <li class="nav-item nav-video"><a class="item-video "
                                        href="https://streamvid.jwsuperthemes.com/author/emily/video"> <span
