                ...
                <div class="header__content">
                    ...
                    <ul class="header__nav">
                        ...
                        <li class="header__nav-item">
                            <a class="header__nav-link header__nav-link--live" href="{{ route('home') }}">Home</a>
                        </li>
                        <li class="header__nav-item">
                            ...
                            <ul class="dropdown-menu header__nav-menu" aria-labelledby="dropdownMenu1">
                                <li><a href="{{ route('category.index') }}">Catalog</a></li>
                    ...
                    <div class="header__actions">
                        <form action="{{ route('category.filter') }}" method="GET" class="header__form">
                            @csrf
                            <input class="header__form-input" name="search" type="text"
                                value="{{ request()->search }}" placeholder="I'm looking for...">
                        ...
                        @if (auth()->check())
                            <li class="header__nav-item">
                                <a class="header__user" href="{{ route('logout') }}">
                                    <span>
                        ...
                        @else
                            <a href="{{ route('signinForm') }}" class="header__user">
                                <span>Sign in</span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
