                                                            ...
                                                            @foreach ($moviesNew as $movie)
                                                                <div class="jws_slider_video_item slider-item"
                                                                    ...
                                                                    <div class="video-background-holder">
                                                                        <div style="background-image: url('{{ Storage::url('images/' . $movie->poster_url) }}');"
                                                                            class="video-images">
                                                                                ...
                                                                                <div class="video-inner">
                                                                                    ...
                                                                                    <div class="video-meta">
                                                                                        <div class="video-imdb"><i
                                                                                                class="fas fa-star"></i>8.2
                                                                                        </div>
                                                                                        <div class="video-years">2023
                                                                                        </div>
                                                                                        <div class="video-time">170
                                                                                            mins</div>
                                                                                        <div class="video-badge">TV-MA
                                                                                        </div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="post-inner">
                                                                        ...
                                                                        <div class="movies-content">
                                                                            ...
                                                                            <div class="video-meta">
                                                                                ...
                                                                                <div class="video-time"> {{ $movie->duration }}
                                                                                </div>
                                                    ...
                                                    <div class="elementor-button-wrapper">
                                                        <a href="#"
                                                            ...
                                                            <span class="elementor-button-content-wrapper">
                                                                ...
                                                                <span class="elementor-button-text">Play
                                                                    Now</span>
                                                            </span>
                                                        </a>
                                                    </div>
