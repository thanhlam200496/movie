	...
	<div class="home home--title">
		...
		<div class="home__carousel owl-carousel" id="flixtv-hero">
			<div class="home__card">
				<a href="details.html">
					<img src="{{asset('clients/img/home/1.jpg')}}" alt="">
				</a>
				<div>
					<h2>Money Plane</h2>
					<ul>
			...
			<div class="home__card">
				<a href="details.html">
					<img src="{{asset('clients/img/home/2.jpg')}}" alt="">
				</a>
				<div>
			...
			<div class="home__card">
				<a href="details.html">
					<img src="{{asset('clients/img/home/3.jpg')}}" alt="">
				</a>
				<div>
					<h2>Antebellum</h2>
					<ul>
			...
			<div class="home__card">
				<a href="details.html">
					<img src="{{asset('clients/img/home/4.jpg')}}" alt="">
				</a>
				<div>
			...
			<div class="home__card">
				<a href="details.html">
					<img src="{{asset('clients/img/home/5.jpg')}}" alt="">
				</a>
				<div>
					<h2>The Empty Man</h2>
					<ul>
			...
			<div class="home__card">
				<a href="details.html">
					<img src="{{asset('clients/img/home/6.jpg')}}" alt="">
				</a>
				<div>
					<h2>Jungleland</h2>
					<ul>
			...
			<div class="home__card">
				<a href="details.html">
					<img src="{{asset('clients/img/home/7.jpg')}}" alt="">
				</a>
				<div>
					<h2>Bad Impulse</h2>
					<ul>
			...
			<div class="home__card">
				<a href="details.html">
					<img src="{{asset('clients/img/home/8.jpg')}}" alt="">
				</a>
				<div>
					<h2>Tenet</h2>
					<ul>
