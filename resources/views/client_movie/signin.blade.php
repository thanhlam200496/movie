                    ...
                    <div class="sign__content">
                        ...
                        <form action="{{ route('signin') }}" method="POST" class="sign__form">
                            ...
                            <div class="sign__social">
                                ...
                                <a class="gl" href="{{route('auth.google')}}"><svg xmlns='http://www.w3.org/2000/svg' class='ionicon'
                                        viewBox='0 0 512 512'>
                                        <path
                            ...
                            <span class="sign__text">Don't have an account? <a href="{{ route('signupForm') }}">Sign
                                    up!</a></span>
