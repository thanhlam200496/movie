                ...
                <div class="row">
                    ...
                    <div class="col-12 col-xl-8">
                        ...
                        <script>
                            ...
                            //         method: 'DELETE', // Hoặc POST, tuỳ thuộc vào logic của bạn
                            //         headers: {
                            //             'Content-Type': 'application/json',
                            //         },
                            //         body: JSON.stringify({
                            //             movie_id: movieId, // ID phim
                            //             user_id: 1, // Mặc định user_id
                            //         }),
                            //     })
                            //     .then(response => {
                            //         if (!response.ok) {
                                ...
                                <div class="section__series owl-carousel" id="series">
                                    <div class="series">
                                        <a href="details.html" class="series__cover">
                                            <img src="{{ asset('clients/img/series/1.jpg') }}" alt="">
                                            <span>
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <div class="series">
                                        <a href="details.html" class="series__cover">
                                            <img src="{{ asset('clients/img/series/2.jpg') }}" alt="">
                                            <span>
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <div class="series">
                                        <a href="details.html" class="series__cover">
                                            <img src="{{ asset('clients/img/series/3.jpg') }}" alt="">
                                            <span>
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <div class="series">
                                        <a href="details.html" class="series__cover">
                                            <img src="{{ asset('clients/img/series/4.jpg') }}" alt="">
                                            <span>
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <div class="series">
                                        <a href="details.html" class="series__cover">
                                            <img src="{{ asset('clients/img/series/5.jpg') }}" alt="">
                                            <span>
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <div class="series">
                                        <a href="details.html" class="series__cover">
                                            <img src="{{ asset('clients/img/series/6.jpg') }}" alt="">
                                            <span>
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
