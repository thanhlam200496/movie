...
@section('main')
    <div class="row">
        ...
        <div class="col-12" style="margin-top: 80px;"> <!-- Adjust for fixed title height -->
            <form action="{{route('admin.leech.slug')}}" class="form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-12 col-sm-6 col-md-12">
                                <div class="form__img">
                                    ...
                                    {{-- <input id="form__img-upload" name="poster_url" type="file"
                                        accept=".png, .jpg, .jpeg"> --}}
                                    <img id="form__img" src="{{$movies['poster_url']}}" alt=" ">
                                    @error('poster_url')
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="form__group">
                                    <input type="text" class="form__input"  name="slug" value="{{request()->leechUrl}}"
                                        placeholder="Title">
                                    @error('title')
                                        <div class="main__table-text--red">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form__group">
                                    <input type="text" class="form__input" onkeyup="ChangeToSlug()" id="title" name="title" value="{{$movies['name']}}"
                                        placeholder="Title">
                                    @error('title')
                                        <div class="main__table-text--red">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form__group">
                                    <input type="text" class="form__input" id="slug" name="onlySlug" value="{{ $movies['slug'] }}" readonly
                                        placeholder="Slug">
                                    @error('title')
                                        <div class="main__table-text--red">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-12">
                                <div class="form__group">
                                    <textarea id="text" name="description" class="form__textarea" placeholder="Description">{{ $movies['content'] }}</textarea>
                                    @error('description')
                                        <div class="main__table-text--red">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="form__group">
                                    <input type="text" name="duration" class="form__input"
                                        placeholder="Running timed in minutes" value="{{ preg_replace('/^0+/', '', preg_replace('/\D/', '', $movies['time'])) }}">
                                    @error('duration')
                                        <div class="main__table-text--red">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <select class="js-example-basic-multiple" name="categories_id[]" id="genre"
                                        ...
                                        @foreach ($categories as $item)
                                            <option value="{{ $item->id }}"
                                                @if (in_array($item->id, old('categories_id', []))) selected @endif>
                                                {{ $item->name }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="col-12 col-lg-6">
                                <ul class="form__radio">
                                    ...
                                    <li>
                                        <input id="type1" type="radio" value="Movie" name="type_film" checked>
